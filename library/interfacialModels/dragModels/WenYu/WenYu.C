...
namespace particleDragModels
{
    ...
    addToRunTimeSelectionTable(particleDragModel, WenYu, dictionary);
}
}
...
Foam::particleDragModels::WenYu::WenYu
(
...
Foam::tmp<Foam::volScalarField> Foam::particleDragModels::WenYu::CdRe() const
{
