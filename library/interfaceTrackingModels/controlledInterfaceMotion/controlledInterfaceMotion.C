...
#include "controlledInterfaceMotion.H"
#include "phasePair.H"
...
{
    defineTypeNameAndDebug(controlledInterfaceMotion, 0);
    addToRunTimeSelectionTable(interfaceTrackingModel, controlledInterfaceMotion, dictionary);
}
}
...
Foam::interfaceTrackingModels::controlledInterfaceMotion::controlledInterfaceMotion
(
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void Foam::interfaceTrackingModels::controlledInterfaceMotion::correct()
{
...
Foam::scalar Foam::interfaceTrackingModels::controlledInterfaceMotion::rb(scalar P)
{
  if (P > 1e6)
...
// void Foam::interfaceTrackingModels::controlledInterfaceMotion::regress
// (
...
Foam::label Foam::interfaceTrackingModels::controlledInterfaceMotion::findNeighbour
(
  const volScalarField& alpha,
  scalar NEI
)
...
void Foam::interfaceTrackingModels::controlledInterfaceMotion::findInterface
(
  const volScalarField& alpha
)
{
...
Foam::interfaceTrackingModels::controlledInterfaceMotion::interface() const
{
    return Foam::tmp<Foam::volScalarField>(new volScalarField("tinterface", interface_));
}

Foam::tmp<Foam::volScalarField>
Foam::interfaceTrackingModels::controlledInterfaceMotion::rb() const
{
    return Foam::tmp<Foam::volScalarField>(new volScalarField("trb", rb_));
}

Foam::tmp<Foam::volScalarField>
Foam::interfaceTrackingModels::controlledInterfaceMotion::As() const
{
    return Foam::tmp<Foam::volScalarField>(new volScalarField("tAs", As_));
}

Foam::tmp<Foam::volVectorField>
Foam::interfaceTrackingModels::controlledInterfaceMotion::nHat() const
{
    return As_*dimensionedScalar(dimLength, 1.0)*vector(1, 0, 0)/max(Foam::mag(As_*dimensionedScalar(dimLength, 1.0)), SMALL);
}

Foam::tmp<Foam::volScalarField>
Foam::interfaceTrackingModels::controlledInterfaceMotion::dmdt() const
{
